     128,   129,   130,   131,   132,   133,   134,   121,   125,   181,
     126,   127,   128,   129,   130,   131,   132,   133,   134,   121,
     122,   123,    96,    97,    33,    38,   131,   132,   133,   134,
      47,   125,    48,   126,   127,   128,   129,   130,   131,   132,
     133,   134,   102,    49,    54,   103,   104,   143,    55,   102,
      56,   105,   103,   104,   176,    57,    59,    62,   105,   106,
     102,    63,    64,   103,   104,    68,   106,    73,    75,   105,
      80,   107,    83,   100,   101,   111,   115,   106,   107,   121,
     122,   123,    84,    85,    86,   171,   163,   172,    87,   107,
     165,   125,   166,   126,   127,   128,   129,   130,   131,   132,
     133,   134,    83,   137,   168,   169,   135,   121,   122,   123,
     170,   178,    84,    85,    86,   184,   180,   182,    87,   125,
     185,   126,   127,   128,   129,   130,   131,   132,   133,   134,
     167,   183,   186,    70,   121,   122,   123,    65,    58,    30,
      66,    71,   112,     0,     0,     0,   125,     0,   126,   127,
     128,   129,   130,   131,   132,   133,   134,   175,     0,     0,
       0,   121,   122,   123,     0,     0,     0,     0,     0,     0,
       0,     0,     0,   125,     0,   126,   127,   128,   129,   130,
     131,   132,   133,   134,   121,   122,   123,     0,     0,     0,
       0,     0,     0,     0,     0,     0,   125,     0,   126,   127,
     128,   129,   130,   131,   132,   133,   134,     0,   141,   121,
     122,   123,     0,     0,     0,     0,     0,     0,     0,     0,
       0,   125,     0,   126,   127,   128,   129,   130,   131,   132,
     133,   134,     0,   147,   121,   122,   123,     0,     0,     0,
       0,     0,   124,     0,     0,     0,   125,     0,   126,   127,
...
static const yytype_int16 yycheck[] =
{
     ...
     172,    38,   139,    10,    46,    55,     9,     9,    19,    20,
      ...
      36,    37,     9,    41,    39,    12,    13,    14,     5,     9,
       9,    18,    12,    13,    14,     6,     3,     9,    18,    26,
       9,     6,    41,    12,    13,    40,    26,    44,    40,    18,
       9,    38,     9,    38,    38,    45,     9,    26,    38,    15,
      16,    17,    19,    20,    21,    22,    28,    24,    25,    38,
       5,    27,     5,    29,    30,    31,    32,    33,    34,    35,
      36,    37,     9,    11,     9,    39,    42,    15,    16,    17,
       6,     5,    19,    20,    21,    22,     5,    39,    25,    27,
       5,    29,    30,    31,    32,    33,    34,    35,    36,    37,
      11,     9,     5,    63,    15,    16,    17,    55,    48,    25,
      57,    64,    97,    -1,    -1,    -1,    27,    -1,    29,    30,
...
/* Line 1806 of yacc.c  */
#line 296 "func.y"
    { fname = (char *)malloc(30); strcpy(fname,(yyvsp[(2) - (2)].n)->NAME); headArg = (struct ArgStruct*)NULL;
...
#line 454 "func.y"
    { (yyval.n) = (yyvsp[(1) - (1)].n); struct Lsymbol* lt = Llookup((yyvsp[(1) - (1)].n)->NAME, Lnode); if(lt) (yyval.n)->TYPE=lt->TYPE; else {
                                                            ...
                                                            else { printf("ID %s not found\n",(yyvsp[(1) - (1)].n)->NAME); yyerror("ID "); (yyval.n)->TYPE=-1;}}}
    break;
...
#line 458 "func.y"
    {   (yyvsp[(1) - (4)].n)->center = (yyvsp[(3) - (4)].n); (yyval.n) = (yyvsp[(1) - (4)].n);  struct Gsymbol* gt = Glookup((yyvsp[(1) - (4)].n)->NAME);
                                                                    ...
                                                                    else { printf("Array %s not found\n",(yyvsp[(1) - (4)].n)->NAME); yyerror("Array"); (yyval.n)->TYPE=-1;}}
    break;
...
/* Line 1806 of yacc.c  */
#line 536 "func.y"
    { (yyvsp[(3) - (3)].n)->PASSTYPE=0; (yyval.n)=CreateNode(0,'z', 0, NULL,(yyvsp[(1) - (3)].n),(yyvsp[(3) - (3)].n),NULL); pcount++;  }
    break;
...
/* Line 1806 of yacc.c  */
#line 537 "func.y"
    { (yyvsp[(4) - (4)].n)->PASSTYPE=1; struct Lsymbol* lt = Llookup((yyvsp[(4) - (4)].n)->NAME, Lnode); if(lt) (yyvsp[(4) - (4)].n)->TYPE=lt->TYPE; else {
                                                            struct Gsymbol* gt = Glookup((yyvsp[(4) - (4)].n)->NAME);
                                                            if(gt) {if(gt->SIZE==0) (yyvsp[(4) - (4)].n)->TYPE=gt->TYPE; else (yyvsp[(4) - (4)].n)->TYPE=-1; }
                                                            else { printf("ID %s not found\n",(yyvsp[(4) - (4)].n)->NAME); yyerror("ID "); (yyvsp[(4) - (4)].n)->TYPE=-1;}} (yyval.n)=CreateNode(0,'z', 0, NULL,(yyvsp[(1) - (4)].n),(yyvsp[(4) - (4)].n),NULL); pcount++;  }
    break;
...
/* Line 1806 of yacc.c  */
#line 541 "func.y"
    { (yyvsp[(1) - (1)].n)->PASSTYPE=0; (yyval.n)=CreateNode(0,'z', 0, NULL,NULL,(yyvsp[(1) - (1)].n),NULL); pcount++;  }
    break;
...
/* Line 1806 of yacc.c  */
#line 542 "func.y"
    { (yyvsp[(2) - (2)].n)->PASSTYPE=1; struct Lsymbol* lt = Llookup((yyvsp[(2) - (2)].n)->NAME, Lnode); if(lt) (yyvsp[(2) - (2)].n)->TYPE=lt->TYPE; else {
                                                            struct Gsymbol* gt = Glookup((yyvsp[(2) - (2)].n)->NAME);
                                                            if(gt) {if(gt->SIZE==0) (yyvsp[(2) - (2)].n)->TYPE=gt->TYPE; else (yyvsp[(2) - (2)].n)->TYPE=-1; }
                                                            else { printf("ID %s not found\n",(yyvsp[(2) - (2)].n)->NAME); yyerror("ID "); (yyvsp[(2) - (2)].n)->TYPE=-1;}} (yyval.n)=CreateNode(0,'z', 0, NULL,NULL,(yyvsp[(2) - (2)].n),NULL);  pcount++;}
    break;
