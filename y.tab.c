...
{
      11,     0,    -1,    12,    -1,    12,     7,    12,    -1,    12,
       6,    12,    -1,    12,     5,    12,    -1,    12,     4,    12,
      -1,     8,    12,     9,    -1,     3,    -1
};
...
{
  "$end", "error", "$undefined", "NUM", "OP1", "OP2", "OP3", "OP4", "'('",
  "')'", "$accept", "start", "expr", 0
};
#endif
...
#line 41 "jas.y"
    {
					(yyval.n)=(yyvsp[(2) - (3)].n);
					(yyval.n)->left=(yyvsp[(1) - (3)].n);
					(yyval.n)->right=(yyvsp[(3) - (3)].n);
				}
    break;
