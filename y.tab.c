...
static const short yylhs[] = {                           -1,
   ...
   36,   36,   17,   17,   22,   21,   21,   18,   18,   13,
   13,   39,   14,   32,   32,   40,   32,   41,    1,   42,
...
static const short yydefred[] = {                         0,
    3,    0,   30,    0,    0,    2,    8,    9,    4,    0,
    0,   11,    1,   31,    0,    0,    0,    6,   38,   32,
    0,    0,    5,    0,    0,    0,    0,    0,    7,    0,
    0,   35,    0,    0,   24,    0,    0,    0,    0,    0,
   17,   37,    0,   28,    0,   27,    0,    0,    0,    0,
   21,    0,    0,   20,   23,   29,    0,   42,    0,   40,
    0,   16,   22,    0,   26,   44,   39,    0,    0,   19,
    0,   51,   41,   33,   43,    0,   45,    0,   49,    0,
...
"$$1 :",
"function : ftype ID $$1 LPAREN Fparametr RPAREN LFLOWER fbody RFLOWER",
"Gvar : ID",
"Gvar : ID LSQUARE NUMBER RSQUARE",
"$$2 :",
"Gvar : ID $$2 LPAREN parametr RPAREN",
"$$3 :",
...
case 1:
#line 136 "func.y"
	{ printf("PARSING SUCCESS\n"); PrintSymbol(); printTree(yystack.l_mark[0].n); }
break;
case 3:
#line 140 "func.y"
	{/*empty*/}
...
#line 320 "func.y"
	{
        Linstall(yystack.l_mark[0].n->NAME, TYPE, Loffset, 0,0, Lnode);
...
case 92:
#line 491 "func.y"
	{ yyval.n = yystack.l_mark[-1].n; yyval.n->NODETYPE='v'; struct Lsymbol* lt = Llookup(yystack.l_mark[-1].n->NAME, Lnode); if(lt) yyval.n->TYPE=lt->TYPE; else {
