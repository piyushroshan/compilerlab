...
var : ID
	...
	beginbody : BEGINN statements return END {  $$=CreateNode(0,'S', 0, NULL, $2, $3, NULL,NULL );}
	;

statements : { $$ = NULL; }
| statements statement {  $$=CreateNode(0,'S', 0, NULL, $2, $1, NULL, NULL); }
	;
...
astatement : ID ASSIGN expression SEMICOLON { $2 = CreateNode(0,'=', 0, NULL, $1, NULL, $3, NULL); $$=$2; }
	| ID LSQUARE aexpression RSQUARE ASSIGN expression SEMICOLON { $1->center = $3; $5 = CreateNode(0,'=', 0, NULL, $1, NULL, $6, NULL); $$=$5;  }
	;
